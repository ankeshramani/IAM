...
class HomePage extends Component {
    ...
    onBackDashboard = () => {
        ...
        this.setState({
            ...
            selectedEnt: [],
            selectedCertification: [],
        }, () => this.props.history.push(`/${clientId}`))
    }
    ...
    render() {
        ...
        return (
            <div>
                <CustomHeader title={<span><span className="app-title-icon"><img src={require('../../shared/img/appIcon.png')} /></span> {certificateInfo.certificationName || '-'}</span>}/>
                            ...
                            !isChangeTable ?
                                ...
                                !isChangeTable ?  <Button size={"large"} className="ml-10" color="primary" onClick={this.onBackDashboard}>
                                    ...
                                    <Icon type="left-square" theme="filled" />
                                                ...
                                                {
                                                    isChangeTable &&
                                                    <Select placeholder='Show New Access' defaultValue=""
