...
class Certification extends Component {
  ...
  onClick = (id, record) => {
    ...
    this.props.history.push(`/${clientId}/certification/${id}`, record)
  }
  ...
  render() {
    ...
    return (
        <div>
          <CustomHeader title={<span><span className="app-title-icon"><img src={require('../../shared/img/certicon.png')} /></span> {"Certification Dashboard"}</span>}/>
